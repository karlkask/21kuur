...
\end{tabular}
\end{verbatim}
Jooniste lisamiseks kasutatakse käsku includegraphics, mille järel tuleb nurksulgudes määrata joonise suurus ning mille argumendiks on pildi nimetus ilma faililaiendita. Näites toodud joonise suurus on 2,5 sentimeetrit.
\begin{verbatim}
\includegraphics[scale=width=2.5cm]{faili_nimetus}
\end{verbatim}
...
% pärast käsu \appendix kasutamist lisatakse peatüki asemel 
lisa.
